<?php
/*Template name: Plantilla del Profesores Jefes*/
get_header();
      ...
      <div class="container">
         <div class="row">
            ...
            <div class="gr-9 gr-10@large gr-12@tablet prefix-1 prefix-0@large">
               ...
               <?php
               $terms_niveles = get_terms('tipo_niveles', array('orderby'=> 'id'));
               foreach($terms_niveles as $key => $terms_nivel) {
