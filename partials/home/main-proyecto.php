<section class="horizon">
   <div class="container">
      <div class="horizon__intro horizon__intro--center">
         <?php
         $habilitar = get_field('activar_link_proyecto');
         $link = get_field('link_titulo_proyecto');
         $titulo = get_field('titulo_seccion_proyecto');
         ?>
         <?php
            $intro_seccion = '';
      ...
      <div class="row" data-equalize="target" data-mq="tablet-down" data-eq-target="[data-eq]">
         <?php $pagina_destacada = get_field('pagina_destacada_proyecto');?>
         <?php if ($pagina_destacada): ?>
            <div class="gr-8 gr-12@medium no-gutter gutter-horizontal@tablet">
               <article class="box box--absolute left" data-eq>
                  ...
                  <div class="box__body">
                     <h4 class="box__title">
                        <a href="<?php echo get_permalink($pagina_destacada['destacada'][0]->ID) ?>" title="<?php echo $pagina_destacada['destacada'][0]->post_title ?>"><?php echo $pagina_destacada['destacada'][0]->post_title ?></a>
                     </h4>
                     <div class="box__excerpt">
                        <?php echo $pagina_destacada['bajada_pagina'] ?>
                     </div>
                     <div class="box__action">
                        <a href="<?php echo get_permalink($pagina_destacada['destacada'][0]->ID) ?>" title="Leer más" class="button button--main button--more">Leer más</a>
                     </div>
                  </div>
               </article>
            </div>
         ...
         <?php $paginas_relacionadas = get_field('paginas_relacionadas_proyecto');?>
            ...
            <div class="gr-4 gr-12@medium no-gutter gutter-horizontal@tablet" data-eq>
               <?php foreach ($paginas_relacionadas['relacionadas'] as $pagina_relacionada): ?>
                  <article class="box box--card">
                     ...
                     <div class="box__body">
                        <h4 class="box__title"><a href="<?php echo $pagina_relacionada['link_pagina'] ?>" title="<?php echo $pagina_relacionada['titulo_pagina'] ?>"><?php echo $pagina_relacionada['titulo_pagina'] ?></a></h4>
                        <div class="box__excerpt">
