(function (window, document, $) {
	...
	var LARGE_DOWN = 'screen and (max-width: 1024px)',
		...
		NADA_DOWN = 'screen and (max-width: 1px)',
		LARGE_SIZE = 1024,
		MEDIUM_SIZE = 800,
		TABLET_SIZE = 768,
		SMALL_SIZE = 640,
	...
	App.prototype = {
		...
		onLoad: function () {
			...
			$('[data-equalize="children"][data-mq="nada-down"]').equalizeChildrenHeights(true, NADA_DOWN);
			...
			$('[data-equalize="target"][data-mq="nada-down"]').equalizeTarget(true, NADA_DOWN);
